...
**Aplicación Web Interactiva:** Una app construida con **Streamlit** para visualizar las predicciones y el desempeño del modelo (Link: https://predictivemaintenance-parisi.streamlit.app/ )
